...
in {
  ...
  nix.extraOptions = ''
    ...
    allowed-uris = https://github.com/cleverca22/nix-tests https://gitlab.com/api/v4/projects/rycee%2Fnmd https://www.leonerd.org.uk/code/libvterm/libvterm-0.3.tar.gz
  '';
