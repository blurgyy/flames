...

{
  ...
  in {
    "api/cloudflare/r2/rclone-nixos/access_key_id" = secretConfig;
    "api/cloudflare/r2/rclone-nixos/secret_access_key" = secretConfig;
    "api/cloudflare/account_id" = secretConfig;
  };
  ...
  sops.templates.rclone-r2-cfg = {
    ...
    content = ''
      ...
      type = s3
      provider = Cloudflare
      access_key_id = ${config.sops.placeholder."api/cloudflare/r2/rclone-nixos/access_key_id"}
      secret_access_key = ${config.sops.placeholder."api/cloudflare/r2/rclone-nixos/secret_access_key"}
      endpoint = https://${config.sops.placeholder."api/cloudflare/account_id"}${lib.optionalString
