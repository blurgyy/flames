{ writeText }: writeText "niz-68ec-keymap.conf" ''
# man:sway-input(5)
# man:xkbcomp(1)
xkb_keymap {
...
xkb_symbols "(unnamed)" {
    ...
    # blurgy: swap <TLDE>'s symbols with <ESC> on NiZ keyboard.
    #key  <ESC> {         [           Escape ] };
    ...
    key <SPCE> {         [           space ] };
    # blurgy: Original content was "Caps_Lock"
    key <CAPS> {         [         Escape  ] };
    key <FK01> {
        type= "CTRL+ALT",
    ...
    ## blurgy: remove this, or <CAPS> works like pressing <CAPS>+<ESC>
