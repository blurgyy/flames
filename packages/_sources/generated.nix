...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  alist = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.27.0";
      fetchSubmodules = false;
      sha256 = "sha256-+yerMDJAT998sZOF6N7/GBPdqhVdtpiwPiVRkFqTCoc=";
    };
  };
  apple-color-emoji = {
  ...
  dnsmasq-china-list = {
    ...
    version = "c993b92b17f890e5ae8da43aa4bd38cd559ed13f";
    src = fetchFromGitHub {
      owner = "felixonmars";
  ...
  loyalsoldier-geoip = {
    ...
    version = "202310112208";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202310112208/geoip.dat";
      sha256 = "sha256-Jqz+Jmv3y3OICN/CCHoIWMcSu1iuJ3bgas/P9uhx2Ds=";
    };
  };
  loyalsoldier-geosite = {
    ...
    version = "202310112208";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202310112208/geosite.dat";
      sha256 = "sha256-anmJunOt11yyXqMBzwnwv03Dn+uGGyVsvXBoNazIIlQ=";
    };
  };
  luarock-dbus_proxy = {
  ...
  simple-icons = {
    ...
    version = "9.13.0";
    src = fetchurl {
      url = "https://github.com/simple-icons/simple-icons-font/releases/download/9.13.0/simple-icons-font-9.13.0.zip";
      sha256 = "sha256-AoWbxzZnsCdC0ERLXz0UUmcMSvBq4GB0KEdQTe3TP98=";
    };
  };
  symbols-nerd-font = {
  ...
  v2ray-rules-dat = {
    ...
    version = "0bf87c91edbe3b5fdc72833cb553ed5b19539b6a";
    src = fetchFromGitHub {
      owner = "loyalsoldier";
      repo = "v2ray-rules-dat";
      rev = "0bf87c91edbe3b5fdc72833cb553ed5b19539b6a";
      fetchSubmodules = false;
      sha256 = "sha256-6M8ZX8IG9ZJS08idtrJ6E6aW5WBeqnWo9T/v1b1OEnA=";
    };
    date = "2023-09-08";
  };
  video-compare = {
