...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  alist = {
    ...
    src = fetchFromGitHub ({
      ...
      rev = "v3.11.0";
      fetchSubmodules = false;
      sha256 = "sha256-YXCcqKUtSp6r3guhkaquP80Pk3RwMkjZmgN8dayCiqQ=";
    });
  };
  aliyundrive-fuse = {
  ...
  loyalsoldier-geoip = {
    ...
    version = "202302182209";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202302182209/geoip.dat";
      sha256 = "sha256-jFUQBxecpl83/7q9yppN6Kp8y5IiM4DE+G08RvHw/DU=";
    };
  };
  loyalsoldier-geosite = {
    ...
    version = "202302182209";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202302182209/geosite.dat";
      sha256 = "sha256-WQsEDO+HJ6jtfPv5Fx4tvrP/0qMh2Iued3vBsalzsfM=";
    };
  };
  luarock-dbus_proxy = {
