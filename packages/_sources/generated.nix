...
{ fetchgit, fetchurl, fetchFromGitHub, dockerTools }:
{
  ...
  loyalsoldier-geoip = {
    ...
    version = "202211302211";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202211302211/geoip.dat";
      sha256 = "sha256-KEj/NO2cVwFJRjgT7Ut0CJsHyHkudduWLypylOIZrSU=";
    };
  };
  loyalsoldier-geosite = {
    ...
    version = "202211302211";
    src = fetchurl {
      url = "https://github.com/Loyalsoldier/v2ray-rules-dat/releases/download/202211302211/geosite.dat";
      sha256 = "sha256-3a3LWYvftZudy1MHzNij22Wekpzr09a3R8kyfboC+rs=";
    };
  };
  luarock-dbus_proxy = {
  ...
  rustdesk-server = {
    ...
    cargoLock."Cargo.lock" = {
      lockFile = ./rustdesk-server-1.1.6-2/Cargo.lock;
      outputHashes = {
  ...
  simple-icons = {
    ...
    version = "7.21.0";
    src = fetchurl {
      url = "https://github.com/simple-icons/simple-icons-font/releases/download/7.21.0/simple-icons-font-7.21.0.zip";
      sha256 = "sha256-VF3apRq6AWVjcnRVgR+yezmxnkUoOE4+isU11fsh5v0=";
    };
  };
  symbols-nerd-font = {
